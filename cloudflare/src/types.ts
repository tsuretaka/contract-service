...
export interface ContractRow {
  ...
  signed_at: string | null; voided_at: string | null;
}
...
export interface SessionRow { id: string; contract_id: string; signer_party_id: string; token_hash: string; expires_at: string; processing_at: string | null; used_at: string | null; created_at: string }
